...
@interface JCSQViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation JCSQViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    JCSQTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell"];
    NSArray *img = @[@"随车附件",@"标志标示",@"防护用品"];
    NSArray *commit =@[@"已提交",@"未提交",@"未提交"];
     NSArray *type =@[@"合格",@"不合格",@"不合格"];
    if (!cell) {
        cell=[[JCSQTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
