...
{
    if (!_progressLabel) {
        _progressLabel = [[UILabel alloc]initWithFrame:CGRectMake((self.bounds.size.width -100)/2, (self.bounds.size.height )/2, 100, 50)];
    }
    _progressLabel.hidden =YES;
    NSLog(@"%@",NSStringFromCGRect(_progressLabel.frame));
